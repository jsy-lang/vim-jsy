" Vim JavaScript syntax file, tailored for embedding in jsy-lang/vim-jsy/syntax/jsy.vim
"      Language: JavaScript
"      Source:   https://github.com/jelera/vim-javascript-syntax/blob/f054138292452ad14fb3bb9dcde3d6224a35a443/syntax/javascript.vim
"    Maintainer:  <https://github.com/jelera>
"       Version: 0.8.2
"       Credits: Jose Elera Campana, Zhao Yi, Claudio Fleiner, Scott Shattuck
"                (This file is based on their hard work),
"                gumnos (From the #vim IRC Channel in Freenode),
"                all the contributors at this project's github page (https://github.com/jelera/vim-javascript-syntax/graphs/contributors)
...
syntax region  javaScriptRegexpString     start=+/[^/*]+me=e-1 skip=+\\\\\|\\/+ end=+/[gim]\{0,2\}\s+me=e-1 end=+/[gim]\{0,2\}\s*$+ end=+/[gim]\{0,2\}\s*[;.,)\]}]+me=e-1 contains=@htmlPreproc oneline
